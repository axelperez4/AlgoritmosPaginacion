	...
	public void mostrarMatriz(){
		...
		for(int i=0;i<cantidadPaginas;i++){
			...
			System.out.print(""+fallos[i]);
                ...
                frame.lru_fallos.setText(String.valueOf(cantidadFallos));
                frame.lru_frecuencia.setText(String.format("%.2f", (frecuencia * (double)100)) + '%');
                frame.lru_rendimiento.setText(String.format("%.2f", (rendimiento * (double)100)) + '%');
